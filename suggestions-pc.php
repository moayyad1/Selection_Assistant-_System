...
<body>
  ...
  <center><label style="font-size:30px;color:black" for="fname">My Use is :</label>
 <br> <input type="radio" id="val1" name="check" value="val1">  GAMING <br> <img style="height:50px" src="https://image.flaticon.com/icons/png/512/3097/3097980.png" >
 <br><br><input type="radio" id="val2" name="check" value="val2">  PROGRAMMING<br /><img style="height:50px" src="https://image.flaticon.com/icons/png/512/2721/2721620.png" ><br>
  <br><input type="radio" id="val3" name="check" value="val3">  BROWSING<br /><img style="height:50px" src="https://image.flaticon.com/icons/png/512/1017/1017951.png" ><br>
 <br><input type="radio" id="val4" name="check" value="val4">  DESIGNING<br /><img style="height:50px" src="https://image.flaticon.com/icons/png/512/395/395690.png" >

</section>
 <center><label style="font-size:30px;color:red;" for="lname"><br>My Budget is:</label>
   <table >
     <tr>
       <td><input type="radio" id="val5" name="check1" value="val5"><img style="height:60px" src="images_db/100_500.png" >  </td><td></td>
       <td> <input type="radio" id="val6" name="check1" value="val6"><img style="height:60px" src="images_db/500_1000.png" ></td><td></td>
       <td> <input type="radio" id="val7" name="check1" value="val7"><img style="height:80px" src="images_db/more_than.png" ></td>
     </tr>
    <tr>
     </tr>
   </table>
...
function redirect()
{
   if    (document.getElementById("val1").checked == true && document.getElementById("val5").checked == true )
      ...
      window.location.href = 'suggest-pc_devices/page6.php';
          ...
          window.location.href = 'suggest-pc_devices/page12.php';
          ...
          window.location.href = 'suggest-pc_devices/page5.php';
  else if(document.getElementById("val4").checked == true && document.getElementById("val7").checked == true)
          window.location.href = 'suggest-pc_devices/page3.php';
